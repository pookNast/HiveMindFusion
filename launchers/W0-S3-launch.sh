#!/usr/bin/env bash
# W0-S3-launch.sh — standalone agent launcher for VRAM calculator library
set -uo pipefail
...
TASK_ID="W0-S3"
PROMPT="/home/pook/ralph/hivemind/prompts/W0-S3-prompt.md"
LOG="/home/pook/ralph/hivemind/logs/W0-S3.log"
