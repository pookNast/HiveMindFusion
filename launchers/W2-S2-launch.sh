#!/usr/bin/env bash
# W2-S2-launch.sh — standalone agent launcher for Fallback chain routing
set -uo pipefail
...
TASK_ID="W2-S2"
PROMPT="/home/pook/ralph/hivemind/prompts/W2-S2-prompt.md"
LOG="/home/pook/ralph/hivemind/logs/W2-S2.log"
