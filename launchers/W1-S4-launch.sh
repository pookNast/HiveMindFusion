#!/usr/bin/env bash
# W1-S4-launch.sh — standalone agent launcher for Rate limiter middleware
set -uo pipefail
...
TASK_ID="W1-S4"
PROMPT="/home/pook/ralph/hivemind/prompts/W1-S4-prompt.md"
LOG="/home/pook/ralph/hivemind/logs/W1-S4.log"
