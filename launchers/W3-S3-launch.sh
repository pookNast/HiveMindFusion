#!/usr/bin/env bash
# W3-S3-launch.sh — standalone agent launcher for hivemind-ctl vram command
set -uo pipefail
...
TASK_ID="W3-S3"
PROMPT="/home/pook/ralph/hivemind/prompts/W3-S3-prompt.md"
LOG="/home/pook/ralph/hivemind/logs/W3-S3.log"
