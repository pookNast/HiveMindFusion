#!/usr/bin/env bash
# W0-S1-launch.sh — standalone agent launcher for Go module + project structure
set -uo pipefail
...
TASK_ID="W0-S1"
PROMPT="/home/pook/ralph/hivemind/prompts/W0-S1-prompt.md"
LOG="/home/pook/ralph/hivemind/logs/W0-S1.log"
