#!/usr/bin/env bash
# W1-S5-launch.sh — standalone agent launcher for Gateway main + server wiring
set -uo pipefail
...
TASK_ID="W1-S5"
PROMPT="/home/pook/ralph/hivemind/prompts/W1-S5-prompt.md"
LOG="/home/pook/ralph/hivemind/logs/W1-S5.log"
