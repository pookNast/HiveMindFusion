#!/usr/bin/env bash
# W6-S1-launch.sh — standalone agent launcher for Integration test suite
set -uo pipefail
...
TASK_ID="W6-S1"
PROMPT="/home/pook/ralph/hivemind/prompts/W6-S1-prompt.md"
LOG="/home/pook/ralph/hivemind/logs/W6-S1.log"
