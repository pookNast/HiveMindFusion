#!/usr/bin/env bash
# W0-S2-launch.sh — standalone agent launcher for TOML config loader
set -uo pipefail
...
TASK_ID="W0-S2"
PROMPT="/home/pook/ralph/hivemind/prompts/W0-S2-prompt.md"
LOG="/home/pook/ralph/hivemind/logs/W0-S2.log"
