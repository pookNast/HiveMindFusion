#!/usr/bin/env bash
# W3-S1-launch.sh — standalone agent launcher for hivemind-ctl models list/info
set -uo pipefail
...
TASK_ID="W3-S1"
PROMPT="/home/pook/ralph/hivemind/prompts/W3-S1-prompt.md"
LOG="/home/pook/ralph/hivemind/logs/W3-S1.log"
