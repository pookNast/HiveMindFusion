#!/usr/bin/env bash
# W3-S2-launch.sh — standalone agent launcher for hivemind-ctl models load/unload/swap
set -uo pipefail
...
TASK_ID="W3-S2"
PROMPT="/home/pook/ralph/hivemind/prompts/W3-S2-prompt.md"
LOG="/home/pook/ralph/hivemind/logs/W3-S2.log"
