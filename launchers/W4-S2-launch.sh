#!/usr/bin/env bash
# W4-S2-launch.sh — standalone agent launcher for Production config.toml
set -uo pipefail
...
TASK_ID="W4-S2"
PROMPT="/home/pook/ralph/hivemind/prompts/W4-S2-prompt.md"
LOG="/home/pook/ralph/hivemind/logs/W4-S2.log"
