#!/usr/bin/env bash
# W5-S1-launch.sh — standalone agent launcher for RAG context injection middleware
set -uo pipefail
...
TASK_ID="W5-S1"
PROMPT="/home/pook/ralph/hivemind/prompts/W5-S1-prompt.md"
LOG="/home/pook/ralph/hivemind/logs/W5-S1.log"
