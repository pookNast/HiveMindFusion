#!/usr/bin/env bash
# W5-S2-launch.sh — standalone agent launcher for Embedding ingestion endpoint
set -uo pipefail
...
TASK_ID="W5-S2"
PROMPT="/home/pook/ralph/hivemind/prompts/W5-S2-prompt.md"
LOG="/home/pook/ralph/hivemind/logs/W5-S2.log"
