#!/usr/bin/env bash
# W2-S3-launch.sh — standalone agent launcher for Consumer auth + usage tracking
set -uo pipefail
...
TASK_ID="W2-S3"
PROMPT="/home/pook/ralph/hivemind/prompts/W2-S3-prompt.md"
LOG="/home/pook/ralph/hivemind/logs/W2-S3.log"
