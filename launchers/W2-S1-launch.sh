#!/usr/bin/env bash
# W2-S1-launch.sh — standalone agent launcher for PII middleware — request/response scanning
set -uo pipefail
...
TASK_ID="W2-S1"
PROMPT="/home/pook/ralph/hivemind/prompts/W2-S1-prompt.md"
LOG="/home/pook/ralph/hivemind/logs/W2-S1.log"
