#!/usr/bin/env bash
# W1-S1-launch.sh — standalone agent launcher for OpenAI-compatible proxy handler
set -uo pipefail
...
TASK_ID="W1-S1"
PROMPT="/home/pook/ralph/hivemind/prompts/W1-S1-prompt.md"
LOG="/home/pook/ralph/hivemind/logs/W1-S1.log"
