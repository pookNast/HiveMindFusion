#!/usr/bin/env bash
# W4-S3-launch.sh — standalone agent launcher for Migrate oc-start to use gateway
set -uo pipefail
...
TASK_ID="W4-S3"
PROMPT="/home/pook/ralph/hivemind/prompts/W4-S3-prompt.md"
LOG="/home/pook/ralph/hivemind/logs/W4-S3.log"
