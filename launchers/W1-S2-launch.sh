#!/usr/bin/env bash
# W1-S2-launch.sh — standalone agent launcher for Backend health checker
set -uo pipefail
...
TASK_ID="W1-S2"
PROMPT="/home/pook/ralph/hivemind/prompts/W1-S2-prompt.md"
LOG="/home/pook/ralph/hivemind/logs/W1-S2.log"
