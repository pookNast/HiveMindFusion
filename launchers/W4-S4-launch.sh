#!/usr/bin/env bash
# W4-S4-launch.sh — standalone agent launcher for Grafana dashboard JSON
set -uo pipefail
...
TASK_ID="W4-S4"
PROMPT="/home/pook/ralph/hivemind/prompts/W4-S4-prompt.md"
LOG="/home/pook/ralph/hivemind/logs/W4-S4.log"
